...
public class RegisterRecebimentoView {
    ...
    private static void cadastrarRecebimentos(RecebimentoDao dao) {
        try {
            Recebimento recebimento1 = new Recebimento(25, 150.75, "2024-10-16");
            Recebimento recebimento2 = new Recebimento(25, 200.00, "2024-10-17");
            Recebimento recebimento3 = new Recebimento(25, 50.25, "2024-10-18");
            Recebimento recebimento4 = new Recebimento(25, 300.00, "2024-10-19");
            Recebimento recebimento5 = new Recebimento(25, 100.75, "2024-10-20");
